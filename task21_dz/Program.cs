...
//Ввод данных
Console.Clear();
Console.WriteLine("Программа напишет растояние между 2мя точками в 3D пространстве");
Console.Write("Введите кардинату X точки А: ");
int userCoordinateX1 = Convert.ToInt32(Console.ReadLine());
Console.Write("Введите кардинату Y точки А: ");
int userCoordinateY1 = Convert.ToInt32(Console.ReadLine());
Console.Write("Введите кардинату Z точки А: ");
int userCoordinateZ1 = Convert.ToInt32(Console.ReadLine());
Console.Write("Введите кардинату X точки B: ");
int userCoordinateX2 = Convert.ToInt32(Console.ReadLine());
Console.Write("Введите кардинату Y точки B: ");
int userCoordinateX2 = Convert.ToInt32(Console.ReadLine());
Console.Write("Введите кардинату Z точки B: ");
int userCoordinateX2 = Convert.ToInt32(Console.ReadLine());
